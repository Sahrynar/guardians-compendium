      ...
      <div style={{ padding: '10px', background: 'rgba(255,255,255,.02)', borderRadius: 'var(--r)', marginBottom: 14 }}>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <button onClick={addTag}
            style={{ padding: '5px 10px', borderRadius: 4, border: 'none', background: '#38b000', color: '#000', fontSize: '0.77em', fontWeight: 700, cursor: 'pointer', flexShrink: 0 }}>+ Add</button>
        </div>
      </div>

      <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
        <button className="btn btn-outline btn-sm" onClick={onClose}>Cancel</button>
        <button className="btn btn-primary btn-sm" style={{ background: '#38b000' }} onClick={save}>Save Tags</button>
      </div>
    </div>
  )
}
...
export default function Journal() {
  ...
  const zones = [
    { id: 'capture', label: '⚡ Capture', color: '#38b000' },
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14, flexWrap: 'wrap', gap: 8 }}>
        <div style={{ fontFamily: "'Cinzel',serif", fontSize: '1.15em', color: '#38b000' }}>
          📓 Journal
        </div>
      ...
      {showTagManager && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontFamily: "'Cinzel',serif", fontSize: '1.08em', marginBottom: 14, color: '#38b000' }}>🏷 Manage Tags</div>
